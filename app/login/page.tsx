      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 xl:px-32 relative z-10">
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              <input 
                ...
                className={`w-full h-12 px-4 rounded-md border-2 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 focus:ring-0 transition-colors ${errors.emailOrUsername ? 'border-red-500 focus:border-red-500' : 'border-zinc-200 dark:border-zinc-800 focus:border-blue-500'}`} 
              />
            ...
            <div className="flex items-center justify-between text-sm py-2">
              <label className="flex items-center gap-2 text-zinc-600 dark:text-zinc-400 font-medium cursor-pointer">
                <input type="checkbox" className="rounded border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-blue-600 focus:ring-blue-500 w-4 h-4" /> Remember me
              </label>
              <Link href="/forgot-password" className="text-blue-600 dark:text-blue-500 font-medium hover:text-blue-700 dark:hover:text-blue-400 hover:underline transition-all">Forgot Password?</Link>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-zinc-600 dark:text-zinc-400 font-medium">
            Don't have an account? <Link href="/signup" className="text-blue-600 dark:text-blue-500 hover:text-blue-700 dark:hover:text-blue-400 hover:underline transition-all">Sign up</Link>
          </p>

          <div className="mt-8 flex justify-center gap-4 opacity-75">
            <div className="h-10 w-32 bg-zinc-100 dark:bg-zinc-900 rounded border border-zinc-200 dark:border-zinc-800 flex items-center justify-center font-semibold text-xs text-zinc-400 dark:text-zinc-500">App Store</div>
            <div className="h-10 w-32 bg-zinc-100 dark:bg-zinc-900 rounded border border-zinc-200 dark:border-zinc-800 flex items-center justify-center font-semibold text-xs text-zinc-400 dark:text-zinc-500">Google Play</div>
          </div>
        </div>
      </div>
