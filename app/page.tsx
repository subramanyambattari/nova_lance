          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-start pt-8 lg:pt-12">
              <div className="max-w-2xl">
                ...
                <div className="bg-white/5 border border-white/10 p-2 rounded-2xl flex items-center mb-6 shadow-2xl backdrop-blur-sm max-w-xl">
                  <div className="flex-1 px-4 text-zinc-400 flex items-center gap-2">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                    What service are you looking for today?
                  </div>
                  <Button className="bg-violet-600 hover:bg-violet-700 text-white rounded-xl px-6 h-12">Search</Button>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3 mb-10 text-sm">
                  ...
                  {["Website Design", "WordPress", "Logo Design", "AI Services"].map(tag => (
                    <span key={tag} className="px-3 py-1.5 rounded-full border border-white/10 text-zinc-300 hover:bg-white/5 cursor-pointer transition-colors">
                      {tag}
                    </span>
                  ))}
                </div>
        ...
        <section className="py-24 bg-zinc-950 border-y border-white/5 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-zinc-400 max-w-2xl mx-auto text-lg">Hire professionals that other clients absolutely love working with.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="bg-black border border-white/10 rounded-3xl p-6 hover:border-violet-500/50 transition-all duration-300 group hover:-translate-y-2 hover:shadow-2xl hover:shadow-violet-900/20">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-violet-500 to-blue-500 p-[2px]">
                        <div className="w-full h-full bg-black rounded-full flex items-center justify-center text-lg font-bold text-white">
                          {freelancer.name.charAt(0)}
                        </div>
                      </div>
                      <div>
                        <h3 className="font-bold text-white group-hover:text-violet-400 transition-colors">{freelancer.name}</h3>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {freelancer.skills.map(skill => (
                      <span key={skill} className="px-2 py-1 bg-white/5 rounded-md text-xs text-zinc-300 border border-white/5">{skill}</span>
                    ))}
                  </div>
                  
                  <div className="flex items-center justify-between pt-4 border-t border-white/10">
                    <span className="font-bold text-white">{freelancer.rate}</span>
                    <Button variant="ghost" className="text-violet-400 hover:text-white hover:bg-violet-600 h-8 text-xs rounded-lg">View Profile</Button>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="py-24 bg-black relative">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-zinc-400 max-w-2xl mx-auto text-lg">See what clients and freelancers are saying about Nova Lance.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="bg-zinc-950/80 backdrop-blur-xl border border-white/10 p-8 rounded-3xl relative">
