  ...
  return (
    <div className="min-h-screen overflow-hidden bg-zinc-950 text-zinc-100">
      <div className="pointer-events-none fixed inset-0 -z-0">
        ...
        <div className="absolute right-10 top-80 h-96 w-96 rounded-full bg-violet-500/10 blur-3xl" />
      </div>
      <div className="relative z-0 mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
        ...
        >
          <div>
            <p className="text-sm font-medium text-blue-300">Freelancer billing</p>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button type="button" className="rounded-xl bg-white text-zinc-950 hover:bg-blue-100">
          ...
          <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, delay: 0.05 }}>
            <Card className="rounded-2xl border-white/10 bg-white/[0.045] shadow-2xl shadow-black/20 backdrop-blur-xl">
              <CardContent className="p-5">
                ...
                <p className="mt-5 text-sm text-zinc-500">Current plan</p>
                <div className="mt-2 flex items-center gap-2">
                  <p className="text-2xl font-semibold text-white">Nova Pro</p>
                  <Badge variant="premium">Active</Badge>
                </div>
                <p className="mt-3 text-sm text-zinc-400">$29/month · renews June 1</p>
              </CardContent>
            </Card>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, delay: 0.1 }}>
            <Card className="rounded-2xl border-white/10 bg-white/[0.045] shadow-2xl shadow-black/20 backdrop-blur-xl">
              <CardContent className="p-5">
                ...
                <p className="mt-5 text-sm text-zinc-500">Platform credits</p>
                <p className="mt-2 text-2xl font-semibold text-white">$184.50</p>
                <p className="mt-3 text-sm text-zinc-400">Available for connects and boosts</p>
              </CardContent>
            </Card>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, delay: 0.15 }}>
            <Card className="rounded-2xl border-white/10 bg-white/[0.045] shadow-2xl shadow-black/20 backdrop-blur-xl">
              <CardContent className="p-5">
                ...
                <p className="mt-5 text-sm text-zinc-500">Next charge</p>
                <p className="mt-2 text-2xl font-semibold text-white">$29.00</p>
                <p className="mt-3 text-sm text-zinc-400">Visa ending 4242 on June 1</p>
              </CardContent>
            </Card>
          </motion.div>
        </section>
        ...
        <section className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
          <Card className="rounded-2xl border-white/10 bg-white/[0.045] shadow-2xl shadow-black/20 backdrop-blur-xl">
            <CardHeader className="flex-row items-center justify-between gap-3">
              <CardTitle className="text-base text-zinc-100">Recent invoices</CardTitle>
              ...
              {invoices.map((invoice) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-zinc-100">{invoice.item}</p>
                  ...
                  <div className="flex items-center gap-3 sm:justify-end">
                    <span className="text-sm font-medium text-zinc-100">{invoice.amount}</span>
          ...
          <Card className="rounded-2xl border-white/10 bg-white/[0.045] shadow-2xl shadow-black/20 backdrop-blur-xl">
            <CardHeader>
              <CardTitle className="text-base text-zinc-100">Plan usage</CardTitle>
            </CardHeader>
