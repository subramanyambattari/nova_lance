              ...
              <div className="relative group py-4">
                ...
                <div className="absolute top-full left-0 w-64 bg-background border border-border rounded-xl shadow-2xl opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-200 z-50 overflow-hidden">
                  <div className="p-2 flex flex-col">
                    <Link href="/login" className="p-3 hover:bg-foreground/5 rounded-lg transition-colors">
                    ...
                    <Link href="/login" className="p-3 hover:bg-foreground/5 rounded-lg transition-colors border border-violet-500/20 bg-violet-500/5 mt-1 relative overflow-hidden group/pro">
                ...
                <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                  ...
                  <nav className="flex flex-col gap-6 mt-8">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <Link href="/login" className="text-muted-foreground hover:text-foreground transition-colors">Hire freelancers</Link>
                      <Link href="/login" className="text-muted-foreground hover:text-foreground transition-colors">Find work</Link>
                      <Link href="/login" className="text-muted-foreground hover:text-foreground transition-colors">Solutions</Link>
                    </div>
