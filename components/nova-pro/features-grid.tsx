...
export function FeaturesGrid() {
  return (
    <section>
      <div className="mb-6">
        <h2 className="text-2xl font-semibold text-white sm:text-3xl">Premium tools built for serious freelancers</h2>
        <p className="mt-2 text-sm text-zinc-400">Every Nova Pro feature is designed to improve visibility, conversion, and payout speed.</p>
      </div>
        ...
        {features.map((feature, index) => {
          ...
          return (
            <motion.div
              ...
              whileHover={{ y: -5 }}
            >
              <Card className="h-full rounded-2xl border-white/10 bg-white/[0.045] p-5 shadow-2xl shadow-black/20 backdrop-blur-xl transition hover:border-blue-400/30">
                <span className="flex size-11 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500/30 to-violet-500/20 text-blue-100">
